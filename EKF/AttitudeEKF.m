function [xa_apo,Pa_apo,Rot_matrix,eulerAngles,debugOutput] = AttitudeEKF(approx_prediction,use_inertia_matrix,x_apo,P_apo,zFlag,dt,z,q_rotSpeed,q_rotAcc,q_acc,q_mag,r_gyro,r_accel,r_mag,J)
...
if(isempty(x_apo))
    ...
    mag_init=single([0.12;-0.59;-0.72]);%[0.120000000000000 -0.590000000000000 -0.720000000000000]
...
%ZYX sequence*/
%phi=atan2(Rot_matrix(3,2),Rot_matrix(3,3)); %X
%theta=-atan(Rot_matrix(3,1) ./ sqrt(1-Rot_matrix(3,1).^2)); %Y
%psi=atan2(Rot_matrix(2,1),Rot_matrix(1,1)); %Z
